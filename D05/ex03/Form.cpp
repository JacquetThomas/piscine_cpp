...
/*   Updated: 2019/04/01 17:13:12 by cjacquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::
NotSignedFormException::NotSignedFormException( void ){ return ;}

Form::
NotSignedFormException::NotSignedFormException ( const NotSignedFormException & inst) {
    *this = inst ;
    return ;
}

Form::
NotSignedFormException::~NotSignedFormException( void ) throw() { return ;}

Form::
NotSignedFormException &Form::NotSignedFormException::operator=(const NotSignedFormException & inst) {
    (void)inst;
    return *this;
}

const  char *Form::NotSignedFormException::what() const throw() {
    return ("Not signed form exception");
}