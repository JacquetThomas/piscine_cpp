...
/*   Updated: 2019/03/29 10:03:07 by cjacquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void        NinjaTrap::ninjaShoebox(FragTrap & frag) {
    std::cout << this->_type << this->_name << " attacks " << frag.getName() << " with saber, causing " << this->_fragTrapAttackDamage << " damages" << std::endl;
}

void        NinjaTrap::ninjaShoebox(ScavTrap & scav) {
    std::cout <<this->_type << this->_name << " attacks " << scav.getName() << " with shuriken, causing " << this->_scavTrapAttackDamage << " damages" << std::endl;
}

void        NinjaTrap::ninjaShoebox(ClapTrap & clap) {
    std::cout << this->_type << this->_name << " attacks " << clap.getName() << " with sai, causing " << this->_clapTrapAttackDamage << " damages" << std::endl;
}

void        NinjaTrap::ninjaShoebox(NinjaTrap & ninja) {
    std::cout << this->_type << this->_name << " can't attacks " << ninja.getName() << " because it's a ninja too" << std::endl;
}
